...
//STATELESS WİDGET
class YoneticiAnaSayfasi extends StatelessWidget {
  const YoneticiAnaSayfasi({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const YoneticiHomeScreen(),
    );
  }
}
//STATELESS WİDGET

//STATELESS WİDGET (YoneticiHomeScreen)
class YoneticiHomeScreen extends StatefulWidget {
  const YoneticiHomeScreen({Key? key}) : super(key: key);

  @override
  State<YoneticiHomeScreen> createState() => _YoneticiHomeScreenState();
}

class _YoneticiHomeScreenState extends State<YoneticiHomeScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      //APPBAR (Up)
                      ...
                      children: [
                        ...
                        Card(
                          ...
                          child: const ListTile(
                            ...
                            subtitle: Text('Tüm Kurumlar Veri Sorgulama'),
                        ...
                        Card(
                          ...
                          child: const ListTile(
                            ...
                            subtitle: Text('Veriye Göre Kurumları Sıralama'),
                        ...
                        Card(
                          ...
                          child: const ListTile(
                            ...
                            subtitle: Text('Okullara Form Oluştur'),
